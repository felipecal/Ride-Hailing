...
export default class TransacationDatabaseRepository implements TransactionRepository {
  constructor(readonly connection: DatabaseConnection) {}
  async save(transaction: Transaction): Promise<void> {
    await this.connection.query('insert into cccat16.transaction (transaction_id, ride_id, amount, status, date) values ($1, $2, $3, $4, $5)', [
